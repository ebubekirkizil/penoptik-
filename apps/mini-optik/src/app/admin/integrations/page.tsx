      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        <div className="bg-white dark:bg-[#1E293B] border border-slate-200 dark:border-slate-700 rounded-3xl p-6 lg:p-8 shadow-sm">
          ...
          <div className="space-y-6 text-slate-600 dark:text-slate-300">
            <p>Sentient Wire sisteminizin pazar yerlerinden sipariş çekebilmesi için sistem IP adresimizi o platformların API ayarlarına beyaz liste (Whitelist) olarak eklemeniz gerekmektedir.</p>
            ...
            <div className="bg-slate-50 dark:bg-slate-900 rounded-xl p-5 border border-slate-200 dark:border-slate-800">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs text-slate-400">Pazar yeri paneline bunu yapıştırın.</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ol className="list-decimal list-inside space-y-2 text-sm">
                <li><strong className="text-slate-800 dark:text-slate-200">Shopify / Trendyol Satıcı Paneline</strong> giriş yapın.</li>
                <li>Ayarlar &gt; Geliştirici &gt; API Entegrasyonları (veya Uygulamalar) sekmesini açın.</li>
                <li>Yeni bir entegrasyon oluşturun ve "IP Beyaz Liste (Whitelist)" alanına yukarıdaki <code>192.168.1.104</code> IP adresini yapıştırın.</li>
                <li>Oluşan <strong className="text-indigo-500">API Key</strong> ve <strong className="text-indigo-500">API Secret</strong> değerlerini kopyalayıp aşağıdaki alana kaydedin.</li>
              </ol>
            </div>
        ...
        <div className="bg-white dark:bg-[#1E293B] border border-emerald-500/20 rounded-3xl p-6 lg:p-8 shadow-sm relative overflow-hidden">
          ...
          <div className="flex items-center gap-3 mb-6 relative z-10">
            ...
            <h2 className="text-xl font-bold text-slate-900 dark:text-white">2. E-Fatura & E-Arşiv (GİB / Uyumsoft) Simülasyonu</h2>
          </div>
          
          <div className="space-y-6 text-slate-600 dark:text-slate-300 relative z-10">
            <p>Satışlarınız yapıldığında devlet sistemine (GİB) otomatik olarak e-fatura/e-arşiv kesilir ve Uyumsoft üzerinden gönderilir. Özelliğin çalışması için yetkilendirme gereklidir.</p>
            ...
            <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-5 border border-emerald-200 dark:border-emerald-800/50">
              ...
              <p className="text-sm text-emerald-700 dark:text-emerald-300">
                Sistem başarıyla Uyumsoft portalına entegre edilmiştir. Artık e-ticaret sitelerinizden gelen siparişler onaylandığı an otomatik faturaya dönüşecek. (Aşağıdan anında test edebilirsiniz.)
              </p>
            </div>
            ...
            <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center gap-4">
              <button onClick={testInvoice} disabled={loading} className="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 text-white font-bold rounded-xl flex items-center gap-2 transition-all shadow-lg shadow-emerald-500/20">
                ...
                {loading ? "GİB'e Gönderiliyor..." : "Sistemi Test Et (Örnek E-Arşiv Oluştur)"}
              </button>
            </div>
              ...
              <div className="mt-6 bg-slate-900 text-white p-5 rounded-2xl animate-in fade-in slide-in-from-bottom-2">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2 text-emerald-400 font-bold">
                    <CheckCircle2 className="w-5 h-5" /> Fatura Başarıyla Kesildi!
                  </div>
