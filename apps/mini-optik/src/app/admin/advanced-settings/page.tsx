...
export default async function AdvancedSettingsPage() {
  ...
  // Mevcut kullanıcının firmasını alalım (şimdilik mock veya ilk firmayı da alabiliriz)
  ...
  return (
    <div className="p-6 md:p-10 max-w-7xl mx-auto  pb-24">
      ...
      {/* Header */}
      <div className="mb-10">
        <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Gelişmiş Kontrol Merkezi</h1>
        <p className="text-slate-500 dark:text-slate-400 mt-2 text-sm md:text-base max-w-3xl">
          ...
          Sadece paketinizde aktif olan modüllerin ayarlarını değiştirebilirsiniz.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-slate-900/50 rounded-3xl p-6 border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow group relative overflow-hidden">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Vergi dairesi, resmi unvan, fatura adresi ve şube tanımlamaları.</p>
        ...
        <div className="bg-white dark:bg-slate-900/50 rounded-3xl p-6 border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow group relative overflow-hidden">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Müşteri arayüzü renkleri, logo, banner ve sayfa yapılandırmaları.</p>
        ...
        <div className={`bg-white dark:bg-slate-900/50 rounded-3xl p-6 border border-slate-100 dark:border-slate-800 shadow-sm transition-all group relative overflow-hidden ${
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">PayTR, İyzico ve Stripe için Merchant ID, Secret Key girişleri.</p>
        ...
        <div className={`bg-white dark:bg-slate-900/50 rounded-3xl p-6 border border-slate-100 dark:border-slate-800 shadow-sm transition-all group relative overflow-hidden ${
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 p-3 rounded-xl text-xs mb-6 font-medium">
            <strong>* Uyumsoft Nedir?</strong> Türkiye'de Gelir İdaresi Başkanlığı (GİB) tarafından onaylanmış, e-Fatura ve e-Arşiv kesmenizi sağlayan resmi aracı firmalardan biridir. Sistemi kullanarak faturalarınızı doğrudan GİB'e iletebilirsiniz.
          </div>
        ...
        <div className={`bg-white dark:bg-slate-900/50 rounded-3xl p-6 border border-slate-100 dark:border-slate-800 shadow-sm transition-all group relative overflow-hidden ${
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Fiziksel mağaza ve ana depolarınızı ekleyin, şubeler arası transfer kurallarını belirleyin.</p>
