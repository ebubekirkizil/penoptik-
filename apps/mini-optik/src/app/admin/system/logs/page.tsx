  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-6">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-muted-foreground text-sm">Personel tarafından yapılan son 100 işlem burada listelenir. Detayları görmek için satıra veya "Göz" simgesine tıklayın.</p>
      </div>
