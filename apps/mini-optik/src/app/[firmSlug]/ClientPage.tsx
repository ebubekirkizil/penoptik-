...
export default function PenOptikLanding({ firm }: { firm: any }) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              <span className="font-black text-xl sm:text-xl tracking-tight text-foreground leading-none">{firm.name.toUpperCase()}</span>
        ...
        <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-lg mb-10 font-medium leading-relaxed">
              {firm.name} ile reçetelerinizi dijitalde saklayın, gözlük ölçümlerinizi takip edin ve sipariş durumunuzu saniyeler içinde sorgulayın.
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="font-black text-xl tracking-tight">{firm.name.toUpperCase()}</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm font-medium text-muted-foreground">
                <li>
                  <a href={`tel:${firm.phone}`} className="flex items-center gap-3 hover:text-primary transition-colors group">
                ...
                <li>
                  <a href={firm.googleMapsUrl || "#"} target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 hover:text-primary transition-colors group">
              ...
              <p>© {new Date().getFullYear()} Pen Optik. Tüm hakları saklıdır.</p>
