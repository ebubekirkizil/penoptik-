  ...
  if (!activeFeatures.includes("MOD_ECOMMERCE_ORDERS")) {
    return (
      <div className="p-6 md:p-10 max-w-4xl mx-auto text-center mt-20">
        ...
        <Link href="/demo/sample-optic/advanced-settings" className="px-6 py-3 bg-indigo-600 text-white font-medium rounded-xl hover:bg-indigo-700 transition-colors">
  ...
  return (
    <div className="p-6 md:p-10 max-w-7xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500 pb-24">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <Link href="/demo/sample-optic/ecommerce/products/new" className="px-5 py-2.5 bg-fuchsia-600 text-white font-medium rounded-xl hover:bg-fuchsia-700 transition-colors flex items-center gap-2 self-start md:self-auto">
                ...
                products.map((product) => (
                  <tr key={product.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/20 transition-colors">
                    ...
                    <td className="px-6 py-4 text-right">
                      <Link 
                        href={`/demo/sample-optic/ecommerce/products/${product.id}`}
